  ...
  if (loading) return (
    <Box sx={{ 
      ...
      <Typography variant="h5" color="primary" sx={{ textAlign: 'center', mb: 1 }}>
        {(() => {
          const messages = [
            "Loading your wealth portfolio...",
            "Counting your investment treasures...",
            "Assembling your financial empire...",
            "Unpacking your money vault...",
            "Calculating your net worth...",
            "Gathering your financial assets...",
            "Preparing your wealth dashboard...",
            "Loading your investment kingdom...",
            "Summoning your portfolio data...",
      ...
      <Typography variant="body2" color="text.secondary" sx={{ textAlign: 'center' }}>
        Your portfolio is loading faster than your investments grow... almost
      </Typography>
    </Box>
  );
